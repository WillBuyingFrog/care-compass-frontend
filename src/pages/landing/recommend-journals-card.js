...
function queryRecommendJournals(subject){
    let ret = []
...
function RecommendJournalsCard({subject}){

    const result = queryRecommendJournals(subject)
    ...
    return (
        ...
        >
            <Box
                height={'15%'}
            >
                <Text fontSize='20px'>{displaySubjectName} 热门期刊</Text>
            </Box>
...
export default RecommendJournalsCard;
